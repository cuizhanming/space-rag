...
class TestCourseSearchTool(unittest.TestCase):
    ...
    def test_execute_with_course_filter(self):
        ...
        result = self.search_tool.execute("python functions", course_name="Advanced Python")
    ...
    def test_execute_with_both_filters(self):
        ...
        self.mock_vector_store.search.return_value = mock_results
        self.mock_vector_store.get_lesson_link.return_value = "https://example.com/ml/lesson5"
    ...
    def test_format_results_with_lesson_links(self):
        ...
        self.assertEqual(self.search_tool.last_sources[0]["text"], "Course A - Lesson 1")
        self.assertEqual(self.search_tool.last_sources[0]["link"], "https://example.com/courseA/lesson1")
