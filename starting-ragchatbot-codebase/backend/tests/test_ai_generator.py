...
class TestAIGenerator(unittest.TestCase):
    ...
    def test_generate_response_with_tools_no_tool_use(self):
        ...
        result = self.ai_generator.generate_response(
            "What is 2+2?", tools=mock_tools, tool_manager=self.mock_tool_manager
        )
    ...
    def test_generate_response_with_tool_use(self):
        ...
        final_content = [
            MockContentBlock(
                "text", text="Based on course content, machine learning..."
            )
        ]
    ...
    def test_execute_tools_single_tool(self):
        ...
        response = MockResponse(content=[tool_use_block], stop_reason="tool_use")
    ...
    def test_execute_tools_multiple_tools(self):
        ...
        response = MockResponse(content=[tool1, tool2], stop_reason="tool_use")
    ...
    def test_api_parameters_structure(self):
        ...
        self.ai_generator.generate_response("Test query", tools=mock_tools)
...
class TestSequentialToolCalling(unittest.TestCase):
    ...
    def test_single_tool_call_backwards_compatibility(self):
        ...
        # Mock tool execution
        self.mock_tool_manager.execute_tool.return_value = (
            "Course content about Python basics"
        )

        # Call generate_response
        result = self.ai_generator.generate_response(
            "What is Python?", tools=mock_tools, tool_manager=self.mock_tool_manager
        )
    ...
    def test_sequential_tool_calling_success(self):
        ...
        final_content = [
            MockContentBlock(
                "text",
                text="Lesson 4 covers functions and covers similar topics to Advanced Python",
            )
        ]
        final_response = MockResponse(content=final_content, stop_reason="end_turn")
        ...
        self.assertEqual(
            result,
            "Lesson 4 covers functions and covers similar topics to Advanced Python",
        )
    ...
    def test_max_rounds_termination(self):
        ...
        tool1_response = MockResponse(
            content=[
                MockContentBlock(
                    "tool_use", name="search_course_content", input={"query": "test1"}
                )
            ],
        ...
        tool2_response = MockResponse(
            content=[
                MockContentBlock(
                    "tool_use", name="search_course_content", input={"query": "test2"}
                )
            ],
            stop_reason="tool_use",
        )
    ...
    def test_tool_execution_error_handling(self):
        ...
        tool_response = MockResponse(
            content=[
                MockContentBlock(
                    "tool_use", name="search_course_content", input={"query": "test"}
                )
            ],
            stop_reason="tool_use",
        )
        ...
        continue_response = MockResponse(
            content=[
                MockContentBlock("text", text="I handled the tool error gracefully")
            ],
            stop_reason="end_turn",
        )
        ...
        result = self.ai_generator.generate_response(
            "Test error handling", tools=mock_tools, tool_manager=self.mock_tool_manager
        )
    ...
    def test_no_tool_use_immediate_response(self):
        ...
        direct_response = MockResponse(
            content=[
                MockContentBlock(
                    "text", text="This is general knowledge, no tools needed"
                )
            ],
            stop_reason="end_turn",
        )
